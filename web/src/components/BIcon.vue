...
// Minimalistische Stroke-Icons — 1.5px strokes, 16px default.
// Lucide-kompatibel (viewBox 0 0 24 24, stroke=currentColor).
// Quelle: design_handoff/components/Icons.jsx — unveraendert portiert.
...
<template>
  ...
  >
    ...
    <path v-else-if="name === 'message'" d="M21 12a9 9 0 1 1-3.6-7.2L21 3v6h-6" />
    ...
    <polyline v-else-if="name === 'chevronRight'" points="9 18 15 12 9 6" />
    <polyline v-else-if="name === 'chevronLeft'" points="15 18 9 12 15 6" />
    <polyline v-else-if="name === 'chevronDown'" points="6 9 12 15 18 9" />
    ...
    <path
      ...
      d="M21.4 11.05L12.25 20.2a5.65 5.65 0 0 1-8-8l9.19-9.19a3.77 3.77 0 0 1 5.33 5.33L9.58 17.52a1.88 1.88 0 0 1-2.66-2.66L15.07 6.7"
    />
    ...
    <template v-else-if="name === 'timeline'">
    ...
    <polyline v-else-if="name === 'arrowUpRight'" points="7 17 17 7 7 7" />
