...
Versionshistorie von Bau-OS. Aelteste Version zuerst.

## v0.1.0 — Initial MVP
**04.04.2026**

Erster funktionsfaehiger Prototyp mit Telegram-Bot, lokalem LLM und Obsidian-Vault.
...
- Vault-Suche ueber alle Markdown-Dateien
- Projekt-Verwaltung mit Unterordnern
- System-Prompt aus Markdown-Dateien (SOUL.md, BOOT.md, etc.)

::: tip MVP-Entscheidung
Bewusste Entscheidung gegen Cloud-AI (OpenAI, etc.) zugunsten von vollstaendiger Datensouveraenitaet. Alle Daten bleiben auf dem eigenen Server.
:::
...
Einfuehrung des Multi-Agent-Systems mit Sub-Agenten, Session-Queue und Tageslog-Komprimierung.
...
- Gespraechsverlauf: Laden der letzten N Eintraege
- PROTECTED_AGENTS: Main-Agent kann nicht geloescht werden
...
Umstellung von Regex-Commands auf LLM Tool Calling. Der Bot versteht jetzt natuerliche Sprache.
...
- Whitelist fuer editierbare Dateien (SOUL.md, BOOT.md, etc.)
- CRUD-Operationen ueber natuerliche Sprache
- `/btw`-Modus: Direkte Antwort ohne Tools und ohne Log
- Memory-Tool: `memory_speichern` fuer Langzeitgedaechtnis
...
- Log-Rotation: Automatisches Kuerzen auf 500 Zeilen
- `/logs [n]` — Letzte Log-Eintraege im Chat anzeigen
...
- Zeitstempel im oesterreichischen Format (de-AT, Europe/Vienna)
...
Komplette Projekt-Restrukturierung: Von 2 grossen Dateien zu 15+ fokussierten Modulen.
...
Die Module-Pfade haben sich geaendert. Alle Imports zeigen jetzt auf Sub-Module statt auf monolithische Dateien.
:::
...
- Umgebungsvariablen fuer LLM-Modelle (`OLLAMA_MODEL`, `OLLAMA_FAST_MODEL`, `OLLAMA_SUBAGENT_MODEL`)
- VitePress-Dokumentation mit vollstaendiger Referenz
...
Geplante Features fuer zukuenftige Versionen:
...
| OENORM-Kalkulations-Agent | Mittel | Geplant |
