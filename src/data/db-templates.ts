...
export function listAvailableVariables(): { name: string; description: string }[] {
  return [
    ...
    { name: "Standort", description: "Projekt-Standort" },
    { name: "Ort", description: "Alias fuer Standort" },
    ...
    { name: "Datum", description: "Heute (TT.MM.JJJJ)" },
    { name: "Tag", description: "Alias fuer Datum" },
    { name: "Heute", description: "Alias fuer Datum" },
